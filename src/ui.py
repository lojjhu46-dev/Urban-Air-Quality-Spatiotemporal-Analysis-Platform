...
def dataset_path_from_env(show_selector: bool = True) -> str:
    ...
    if pending_choice is not None:
        resolved_pending = str(resolve_existing_dataset_path(pending_choice))
    ...
    selected_default = str(resolve_existing_dataset_path(Path(override_value)))
    ...
    current_value = str(resolve_existing_dataset_path(choice_value))
    ...
    resolved_selected = str(resolve_existing_dataset_path(selected))
