...
TRANSLATIONS = {
    ...
    "agent.caption": {"zh-CN": "\u8f93\u5165\u81ea\u5b9a\u4e49\u56fd\u5bb6/\u5730\u533a\u4e0e\u57ce\u5e02\uff0c\u7531 DeepSeek \u6821\u9a8c\u540e\u89c4\u5212\u5e76\u91c7\u96c6\u5386\u53f2\u7a7a\u6c14\u8d28\u91cf\u6570\u636e\u96c6\u3002", "en": "Enter a custom country/region and city, validate the location with DeepSeek, then plan and collect a historical air-quality dataset."},
    ...
    "agent.task_status_label": {"zh-CN": "\u72b6\u6001", "en": "Status"},
    "agent.task_phase_label": {"zh-CN": "\u9636\u6bb5", "en": "Phase"},
    "agent.task_progress_label": {"zh-CN": "\u8fdb\u5ea6", "en": "Progress"},
    "agent.task_state_line": {"zh-CN": "\u72b6\u6001\uff1a{status} | \u9636\u6bb5\uff1a{phase} | \u8fdb\u5ea6\uff1a{progress}", "en": "Status: {status} | Phase: {phase} | Progress: {progress}"},
    "agent.task_output_path": {"zh-CN": "\u8f93\u51fa\u6587\u4ef6\uff1a`{path}`", "en": "Output file: `{path}`"},
    "agent.task_error": {"zh-CN": "\u4efb\u52a1\u9519\u8bef\uff1a{error}", "en": "Task error: {error}"},
    "agent.task_log_section": {"zh-CN": "\u6700\u8fd1\u65e5\u5fd7", "en": "Recent logs"},
    "agent.task_log_item": {"zh-CN": "{created_at} | {level} | {phase} | {message}", "en": "{created_at} | {level} | {phase} | {message}"},
    "agent.task_status_unavailable": {"zh-CN": "\u65e0\u6cd5\u8bfb\u53d6\u4efb\u52a1\u72b6\u6001\uff1a{error}", "en": "Could not read task status: {error}"},
    "agent.task_status_missing": {"zh-CN": "\u627e\u4e0d\u5230\u4efb\u52a1\uff1a{task_id}", "en": "Task not found: {task_id}"},
    "agent.task_timeout": {"zh-CN": "\u4efb\u52a1\u8d85\u8fc7 {seconds} \u79d2\u672a\u5b8c\u6210\u3002", "en": "Task did not finish within {seconds} seconds."},
    "agent.task_stalled_timeout": {"zh-CN": "\u4efb\u52a1\u8d85\u8fc7 {seconds} \u79d2\u6ca1\u6709\u65b0\u8fdb\u5c55\uff0c\u5df2\u6807\u8bb0\u4e3a\u8d85\u65f6\u3002", "en": "Task had no new progress for {seconds} seconds and was marked as timed out."},
    "agent.task_started": {"zh-CN": "\u540e\u53f0 Agent \u4efb\u52a1\u5df2\u542f\u52a8\u3002", "en": "Background agent task started."},
    "agent.api_key_found": {"zh-CN": "\u5df2\u5728 Streamlit secrets \u4e2d\u53d1\u73b0 `deepseek_api_key`\u3002", "en": "Found `deepseek_api_key` in Streamlit secrets."},
    "agent.api_key_optional": {"zh-CN": "\u672a\u914d\u7f6e `deepseek_api_key`\u3002\u81ea\u5b9a\u4e49\u57ce\u5e02\u91c7\u96c6\u9700\u8981\u5148\u914d\u7f6e key \u624d\u80fd\u8fd0\u884c\u3002", "en": "No `deepseek_api_key` found. Custom city collection requires the key before it can run."},
    ...
    "agent.request_section": {"zh-CN": "\u81ea\u5b9a\u4e49\u91c7\u96c6\u8bf7\u6c42", "en": "Custom Collection Request"},
    "agent.request_caption": {"zh-CN": "\u8f93\u5165\u56fd\u5bb6/\u5730\u533a\u548c\u57ce\u5e02\u540d\u79f0\uff0c\u518d\u9009\u62e9\u5e74\u4efd\u3001\u6c61\u67d3\u7269\u548c\u6c14\u8c61\u5b57\u6bb5\u3002\u9875\u9762\u4f1a\u542f\u52a8\u540e\u53f0 Agent \u4efb\u52a1\u5e76\u8f6e\u8be2\u8fdb\u5ea6\u3002", "en": "Enter the country/region and city name, then choose years, pollutants, and weather fields. The page starts a background agent task and polls its progress."},
    ...
    "agent.stable_city_select": {"zh-CN": "\u7a33\u5b9a\u57ce\u5e02\u5019\u9009\uff08\u53ef\u9009\uff09", "en": "Stable city candidate (optional)"},
    "agent.stable_city_placeholder": {"zh-CN": "\u53ef\u9009\uff1a\u4ece\u539f\u6709\u7a33\u5b9a\u57ce\u5e02\u5019\u9009\u4e2d\u5feb\u901f\u586b\u5165", "en": "Optional: fill from the original stable city candidates"},
    "agent.stable_city_prefill_message": {"zh-CN": "\u5df2\u4ece\u7a33\u5b9a\u57ce\u5e02\u5019\u9009\u586b\u5165\uff1a{city}, {country}", "en": "Filled from stable city candidates: {city}, {country}"},
    ...
    "agent.request_preview_caption": {"zh-CN": "\u4e0b\u65b9\u662f\u6839\u636e\u5f53\u524d\u81ea\u5b9a\u4e49\u8f93\u5165\u751f\u6210\u7684\u5185\u90e8\u91c7\u96c6\u6307\u4ee4\u3002", "en": "This is the internal collection instruction generated from the current custom inputs."},
    ...
    "agent.task_plan_ready": {"zh-CN": "\u91c7\u96c6\u8ba1\u5212\u5df2\u751f\u6210\u3002", "en": "Collection plan is ready."},
